...
export const getRoutines = asyncHandler(async (req, res) => {
  ...
  return sendResponse(res, 200,"Routines fetched successfully", routines);
});
...
export const getCurrentRoutine = asyncHandler(async (req, res) => {
  ...
  return sendResponse(res, updated ? 200 : 200, message, routine);
});
...
export const createRoutine = asyncHandler(async (req, res) => {
  ...
  if (blocked) {
    return sendResponse(res, 200, message, routine);
  }

  return sendResponse(res, 201, message, routine);
});
